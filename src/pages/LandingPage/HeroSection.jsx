...
import { Heart, User, Calendar, Activity, Phone, Mail, MapPin, Menu, X, Stethoscope, Brain, Bone, Eye, NotebookPen } from 'lucide-react';
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-24">
                ...
                >
                    ...
                    <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                        <span className="block text-blue-600 xl:inline">Enhancing</span>{' '}
